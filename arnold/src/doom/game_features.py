...
def parse_game_features(s):
    ...
    Returns: a Boolean vector showing which features are requested.
    """
...
class GameFeaturesConfusionMatrix(object):
    ...
    def print_statistics(self):
        ...
        assert len(set(count.ravel())) == 1              ## checking the element in matrix belongs in exactly one of them
        ...
        # Print statistics for all maps combined performance
