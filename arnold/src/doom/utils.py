...
def process_buffers(game, params):
    ...
    Resize the screen.
    Returns:- the conctenated buffers (no_buffers,height,width) and game_features
    """
    ...
    if game.use_labels_buffer or game.use_game_features:
        ...
        # create the final labels buffer  game.labels_mapping is used for using specific combination of labels in the game.
...
def get_n_feature_maps(params):
    """
    Return the number of feature maps used.
    """
    n = 0
